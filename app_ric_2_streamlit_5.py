...
# --- NOVA FUNÇÃO DE DOWNLOAD DE ARQUIVOS DO GOOGLE DRIVE ---
# Esta é uma abordagem mais direta para o download
def download_gdrive_file(file_id, destination):
    ...
    # Verifica se a resposta contém a página de aviso
        ...
        try:
            ...
            with st.spinner("Baixando os modelos..."):
                if not download_gdrive_file(MODEL_F1_ID, path_modelo_f1):
                    # Se o download falhar, interrompe a execução
                    st.stop()
